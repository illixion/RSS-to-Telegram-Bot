...
>>>>>>>> 4b304a3c8c6028d7991c73d3d3d88395a5698811:telegramRSSbot.py
...
def parse_ss(url, min_price, max_price):
    ...
    if page.getcode() == 200:
        ...
        text_to_send = f"""🌐 {url}
📍 [{address_city}, {address_region}, {address_street}]({"http://maps.google.com/?q=" + urllib.parse.quote(", ".join(address_gps))})
🏠 {sq_meters}
🧗‍♀️ {floors}
🚪 {rooms}
🏚 {series}
